...
- 2026-09-24: The user confirmed on the rebuilt Mac app (15:07, with the ultra review fixes) that quitting stops the Python backend. Remaining: Windows quit-while-training check, merge to master.
