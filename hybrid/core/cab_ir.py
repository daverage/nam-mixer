...
`hybrid.modes.fixed_blend`/`hybrid.modes.training_target`/`hybrid.modes.blend_training_target`
...
class CabDesign:
    ...
    (see hybrid.core.cab_ir module docstring / app.py's upload endpoint); the raw
