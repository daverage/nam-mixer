...
docs/final/manifest_frozen.json). The recipe:
  ...
  * target = level-driven blend of the REAL captures (`hybrid.continuous_gain.multi_blend`): capture k owns chain level
...
def receptive_field_record(positions: list[float], loaded_models: dict, envelope_max_history_samples: int | None = None,
    ...
    from ..core.receptive_field import compute_source_nam_receptive_field
