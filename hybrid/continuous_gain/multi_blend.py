"""N-way ordered level-driven blend (Continuous Gain v3): generalises `hybrid.modes.blend` from two amps to an ordered
...
from hybrid.modes.blend import smoothstep_curve
