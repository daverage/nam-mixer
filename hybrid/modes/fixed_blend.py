...
`hybrid.modes.blend.blend` does: Amp A and Amp B renders are correlated versions of
...
def compute_active_trim(
    ...
    hybrid.core.pipeline.render_pair).
    """
...
def build_fixed_blend(
    pair,  # hybrid.core.pipeline.RenderedPair
    mix_b: float,
...
class BlendDesign:
    ...
    # See hybrid.core.pipeline.RenderedPair's docstring -- independent per-amp
