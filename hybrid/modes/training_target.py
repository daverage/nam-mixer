...
from ..core.receptive_field import combine_required_history, compute_source_nam_receptive_field
...
def compute_receptive_field_record(
    ...
    """
    from ..core.receptive_field import ReceptiveFieldUnavailable, compute_a2_receptive_field
