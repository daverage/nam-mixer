...
To get a specific version, open its page under [Releases](https://github.com/daverage/nam-mixer/releases) (for example `https://github.com/daverage/nam-mixer/releases/tag/v0.3.2`) and download from **Assets**.
